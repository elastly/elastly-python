...
class StageRecordsRequestOneOf2(BaseModel):
    """
    StageRecordsRequestOneOf2
    """ # noqa: E501
    entity: StrictStr
    records: Annotated[List[StageRecordsRequestOneOf2RecordsInner], Field(min_length=1, max_length=1000)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [StageRecordsRequestOneOf2RecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
