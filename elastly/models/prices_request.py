...
class PricesRequest(BaseModel):
    ...
    PricesRequest
    """ # noqa: E501
    lines: Annotated[List[PricesRequestLinesInner], Field(min_length=1, max_length=100)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lines": [PricesRequestLinesInner.from_dict(_item) for _item in obj["lines"]] if obj.get("lines") is not None else None
        })
        return _obj
