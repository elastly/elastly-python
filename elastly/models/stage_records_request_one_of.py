...
class StageRecordsRequestOneOf(BaseModel):
    """
    StageRecordsRequestOneOf
    """ # noqa: E501
    entity: StrictStr
    records: Annotated[List[StageRecordsRequestOneOfRecordsInner], Field(min_length=1, max_length=1000)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [StageRecordsRequestOneOfRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
