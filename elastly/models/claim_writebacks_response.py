...
class ClaimWritebacksResponse(BaseModel):
    """
    ClaimWritebacksResponse
    """ # noqa: E501
    tasks: List[ClaimWritebacksResponseTasksInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tasks": [ClaimWritebacksResponseTasksInner.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
