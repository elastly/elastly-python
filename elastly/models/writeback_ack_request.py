...
class WritebackAckRequest(BaseModel):
    """
    WritebackAckRequest
    """ # noqa: E501
    results: Annotated[List[WritebackAckRequestResultsInner], Field(min_length=1, max_length=500)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [WritebackAckRequestResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
