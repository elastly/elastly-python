...
class AckWritebacksResponse(BaseModel):
    """
    AckWritebacksResponse
    """ # noqa: E501
    applied: Annotated[int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)]
    failed: Annotated[int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)]
    expired: Annotated[int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)]
    __properties: ClassVar[List[str]] = ["applied", "failed", "expired"]
