...
class PricesApi:
    ...
    def get_prices(
        self,
        idempotency_key: Annotated[StrictStr, Field(description="Unique key for this logical request. Retries must reuse the same key; a replay returns the stored response.")],
        ...
        :param idempotency_key: Unique key for this logical request. Retries must reuse the same key; a replay returns the stored response. (required)
        :type idempotency_key: str
        :param prices_request: (required)
        :type prices_request: PricesRequest
    ...
    def _get_prices_serialize(
        ...
        if prices_request is not None:
            _body_params = prices_request
