...
from elastly.api_response import ApiResponse, T as ApiResponseT
import elastly.models
from elastly import rest
from elastly.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(elastly.models, klass)
